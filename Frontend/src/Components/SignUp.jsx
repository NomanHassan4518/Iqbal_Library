...
const SignUp = () => {
    ...
    const handleSignup = async (e)=>{
        e.preventDefault()
        let result = await axios.post("https://iqballibrary.vercel.app/signup" , postData , {
            headers:{
  ...
  return (
    <div className='pl-60 py-16 '>
        <p className='absolute top-4 right-5 z-50 w-8 h-8 rounded-full bg-white flex items-center justify-center cursor-pointer' onClick={closeModal}><IoCloseSharp className='text-2xl font-bold'/></p>
       <Modal
        isOpen={modalIsOpen}
        style={customStyles}
